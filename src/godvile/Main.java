...
public class Main {
    private void start(String godName) throws InterruptedException, IOException {
        ...
        // because Notification  requires absolute path
        ...
        while (true) {
            ...
            Notification myNotification = new Notification("Годвилль", stringToNotify.toString(), Constants.getImageWay()); // create the notification object
    ...
    public static void main(String[] args) throws InterruptedException, IOException {
        ...
        if (settings.getFileAddress() != null)
            new Main().start(settings.getGodName(), new File(settings.getFileAddress()));
